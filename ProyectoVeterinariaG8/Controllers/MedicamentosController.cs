...
namespace ProyectoVeterinariaG8.Controllers
{
    public class MedicamentosController : Controller
    {
        ...
        public MedicamentosController(VeterinariaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MedicamentoId,Nombre,Dosis")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicamentoId,Nombre,Dosis")] Medicamento medicamento)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VeterinariaContext.Medicamentos'  is null.");
            }
            var medicamento = await _context.Medicamentos.FindAsync(id);
            if (medicamento != null)
            {
